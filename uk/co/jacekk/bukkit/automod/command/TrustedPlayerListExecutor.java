...
public class TrustedPlayerListExecutor extends BaseCommandExecutor<AutoMod> {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args){
		...
		if (playerList.size() == 1){
			sender.sendMessage(plugin.formatMessage(ChatColor.BLUE + totalNames + " player is trusted:"));
		}else{
			sender.sendMessage(plugin.formatMessage(ChatColor.BLUE + totalNames + " players are trusted:"));
		}
